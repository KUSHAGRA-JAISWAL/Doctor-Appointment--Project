...
<body>
    ...
    echo '<h1 class="text-center text-dark text-decoration-underline mt-5">MY APPOINTMENTS</h1>';

    if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
      $sql = "SELECT usr.user_name, ds.schedule_date, ds.schedule_start_time, ds.schedule_end_time, apt.reason_for_appointment FROM appointment apt, users usr,doctor_schedule ds WHERE apt.doctor_id = $id AND usr.user_id = apt.user_id AND ds.schedule_id = apt.schedule_id";
                        ...
                        <div class="modal-header">
                          ...
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                   ...
                                   <div class="modal-body text-center">
                                      ...
                                      Patient Name: ' . $row['user_name'] . '<hr>
                                      </div>
                                      
                                      <div class="fs-5" id="editScheduleDate" name="editScheduleDate" >
                                      Appointment date: ' . $row['schedule_date'] . '<hr>
                                      </div>
                                      
                                      <div class="fs-5" id="editScheduleTime" name="editScheduleTime" >
                                      Appointment Time: ' . $row['schedule_start_time'] . ' '.$row['schedule_end_time'].'<hr>
                                      </div>
